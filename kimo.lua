...
local kimo = io.open("kimo", 'w')
kimo:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 kimo.lua
done
]])
kimo:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S kimo -X kill
screen -S kimo ./kimo
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x kimo;chmod +x Run;./Run')
end
...
kimo = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..kimo)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=kimo,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(kimo.."kimo:DevelopersQ:Groups",UserId) 
if UserId == 611122715 then
Status = true
elseif UserId == 611122715 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == kimo then
Status = true
...
Status = 0
Developers = Redis:sismember(kimo.."kimo:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(kimo.."kimo:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(kimo.."kimo:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(kimo.."kimo:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(kimo.."kimo:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(kimo.."kimo:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(kimo.."kimo:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(kimo.."kimo:Developer:Bot:Reply"..ChatId) or 'Myth'
elseif TheBasics then
Status = Redis:get(kimo.."kimo:President:Group:Reply"..ChatId) or 'المنشى الاساسي'
elseif Originators then
Status = Redis:get(kimo.."kimo:Constructor:Group:Reply"..ChatId) or 'المنشى'
elseif Managers then
Status = Redis:get(kimo.."kimo:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(kimo.."kimo:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(kimo.."kimo:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(kimo.."kimo:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(kimo.."kimo:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(kimo.."kimo:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(kimo.."kimo:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(kimo.."kimo:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(kimo.."kimo:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(kimo.."kimo:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(kimo.."kimo:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(kimo.."kimo:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(kimo.."kimo:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(kimo.."kimo:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(kimo.."kimo:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(kimo.."kimo:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(kimo.."kimo:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(kimo.."kimo:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(kimo.."kimo:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(kimo.."kimo:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(kimo.."kimo:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(kimo.."kimo:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(kimo.."kimo:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(kimo.."kimo:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(kimo.."kimo:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(kimo.."kimo:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(kimo.."kimo:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(kimo.."kimo:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(kimo.."kimo:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(kimo.."kimo:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(kimo.."kimo:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(kimo.."kimo:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(kimo.."kimo:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(kimo.."kimo:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(kimo.."kimo:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(kimo.."kimo:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(kimo.."kimo:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
kkytmAll = Redis:sismember(kimo.."kimo:kkytmAll:Groups",UserId) ,
BanAll = Redis:sismember(kimo.."kimo:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(kimo.."kimo:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(kimo.."kimo:SilentGroup:Group"..ChatId,UserId)
}
end
...
Managers = Redis:sismember(kimo.."kimo:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(kimo.."kimo:Addictive:Group"..ChatId,UserId)
channelis = Redis:sismember(kimo.."kimo:Managers:Group"..ChatId,UserId)
Distinguished = Redis:sismember(kimo.."kimo:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 611122715 then
Status = true
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,kimo).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(kimo..'kimo:Channel:Join')
if Channel then
...
local msg_id = msg.id
if data.sender.luatele == "messageSenderChat" and Redis:get(kimo.."Lock:channell"..msg_chat_id) and not msg.channelis then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
Redis:incr(kimo..'kimo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(kimo) then
...
if tonumber(msg.sender.user_id) == 611122715 then
msg.Name_Controller = 'المطور كيمو🎖 '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 611122715 then
msg.Name_Controller = 'المطور كيمو🎖'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'Dev🎖'
elseif Redis:sismember(kimo.."kimo:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️'
elseif Redis:sismember(kimo.."kimo:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(kimo.."kimo:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(kimo.."kimo:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(kimo.."kimo:President:Group:Reply"..msg.chat_id) or 'المنشى الاساسي'
elseif Redis:sismember(kimo.."kimo:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(kimo.."kimo:Constructor:Group:Reply"..msg.chat_id) or 'المنشى '
elseif Redis:sismember(kimo.."kimo:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(kimo.."kimo:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(kimo.."kimo:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(kimo.."kimo:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(kimo.."kimo:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(kimo.."kimo:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(kimo) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(kimo.."kimo:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(kimo.."kimo:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(kimo.."kimo:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(kimo.."kimo:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(kimo) then
return false
end
local floods = Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(kimo.."kimo:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(kimo.."kimo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(kimo.."kimo:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(kimo.."kimo:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(kimo.."kimo:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(kimo.."kimo:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(kimo.."kimo:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(kimo.."kimo:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(kimo.."kimo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(kimo.."kimo:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(kimo.."kimo:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(kimo.."kimo:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(kimo.."kimo:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(kimo.."kimo:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(kimo.."kimo:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(kimo.."kimo:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(kimo.."kimo:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(kimo.."kimo:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(kimo.."kimo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(kimo..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(kimo.."kimo:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(kimo.."kimo:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(kimo.."kimo:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(kimo.."kimo:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(kimo.."kimo:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(kimo.."kimo:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(kimo.."kimo:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(kimo.."kimo:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(kimo.."kimo:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(kimo.."kimo:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(kimo.."kimo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(kimo.."kimo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(kimo.."kimo:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(kimo.."kimo:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(kimo.."kimo:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(kimo.."kimo:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(kimo.."kimo:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(kimo.."kimo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(kimo.."kimo:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(kimo.."kimo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(kimo.."kimo:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(kimo.."kimo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(kimo.."kimo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(kimo.."kimo:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(kimo.."kimo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(kimo.."kimo:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(kimo.."kimo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(kimo.."kimo:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(kimo.."kimo:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(kimo.."kimo:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(kimo.."kimo:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(kimo.."kimo:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(kimo.."kimo:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(kimo.."kimo:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(kimo.."kimo:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(kimo.."kimo:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(kimo.."kimo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(kimo.."kimo:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(kimo.."kimo:Command:List:Group"..msg_chat_id,text)
...
Redis:del(kimo.."kimo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(kimo.."kimo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(kimo.."kimo:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(kimo.."kimo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(kimo.."kimo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم ","md",true)  
end
if text and Redis:get(kimo.."kimo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(kimo.."kimo:Command:Reids:Group:New"..msg_chat_id)
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(kimo.."kimo:Command:List:Group"..msg_chat_id,text)
Redis:del(kimo.."kimo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الامر باسم ↢ ( "..text..' ) ',"md",true)
end
if Redis:get(kimo.."kimo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(kimo.."kimo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(kimo.."kimo:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(kimo.."kimo:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(kimo.."kimo:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(kimo.."kimo:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(kimo.."kimo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(kimo.."kimo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(kimo..'kimo:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(kimo.."kimo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(kimo.."kimo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(kimo.."kimo:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(kimo.."kimo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(kimo.."kimo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(kimo.."kimo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(kimo.."kimo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(kimo..'kimo:GetTexting:Devkimo'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(kimo..'kimo:GetTexting:Devkimo'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• اهلا عزيزي , تم الغاء تغيير كليشه Dev🎖')
end
Redis:set(kimo..'kimo:Texting:Devkimo',text)
Redis:del(kimo..'kimo:GetTexting:Devkimo'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم حفظ كليشة Dev🎖')
end
if Redis:get(kimo.."kimo:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء تعيين الايدي عام ","md",true)  
Redis:del(kimo.."kimo:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(kimo.."kimo:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(kimo.."kimo:Set:Id:all",text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '- قناه السورس .', url='https://t.me/d8_8q'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,'• تم تعين الايدي عام الجديد',"md",true, false, false, false, reply_markup)
end
if Redis:get(kimo.."kimo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء تعيين الايدي ","md",true)  
Redis:del(kimo.."kimo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(kimo.."kimo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(kimo.."kimo:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(kimo.."kimo:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(kimo.."kimo:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء اسم البوت ","md",true)  
end 
Redis:del(kimo.."kimo:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(kimo.."kimo:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير اسم البوت الى • "..text,"md",true)    
end 
if Redis:get(kimo.."kimo:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(kimo.."kimo:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء تغيير كليشه start","md",true)  
end 
Redis:del(kimo.."kimo:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(kimo.."kimo:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير كليشه start • "..text,"md",true)    
end 
if Redis:get(kimo.."kimo:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(kimo.."kimo:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(kimo.."kimo:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(kimo.."kimo:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(kimo.."kimo:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(kimo.."kimo:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , تم الغاء الترحيب ","md",true)   
end 
Redis:del(kimo.."kimo:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(kimo.."kimo:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(kimo.."kimo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(kimo.."kimo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , تم الغاء القوانين","md",true)   
end 
Redis:set(kimo.."kimo:Group:Rules" .. msg_chat_id,text) 
Redis:del(kimo.."kimo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(kimo.."kimo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(kimo.."kimo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text == "الغاء" then 
Redis:del(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , تم الغاء الرد","md",true)   
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(kimo.."kimo:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(kimo.."kimo:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(kimo.."kimo:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."kimo:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(kimo.."kimo:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(kimo.."kimo:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(kimo.."kimo:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(kimo.."kimo:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(kimo.."kimo:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
print(idPhoto)
Redis:set(kimo.."kimo:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"• اضفت الرد بنجاح \n• ارسل ( "..test.." ) لتشوف الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(kimo.."kimo:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(kimo.."kimo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(kimo.."kimo:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(kimo.."kimo:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/d8_8q'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
if text and text:match("^(.*)$") then
if Redis:get(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(kimo.."kimo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(kimo.."kimo:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(kimo.."kimo:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(kimo.."kimo:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود ","md",true)  
return false
end
end
if text and Redis:get(kimo.."kimo:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(kimo.."kimo:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(kimo.."kimo:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(kimo.."kimo:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(kimo.."kimo:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(kimo.."kimo:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(kimo.."kimo:Add:Rd:Sudo:Video"..text)
local document = Redis:get(kimo.."kimo:Add:Rd:Sudo:File"..text)
local audio = Redis:get(kimo.."kimo:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(kimo.."kimo:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(kimo..'kimo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(kimo..'kimo:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(kimo.."kimo:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(kimo.."kimo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(kimo.."kimo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(kimo.."kimo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(kimo.."kimo:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(kimo.."kimo:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(kimo.."kimo:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(kimo.."kimo:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(kimo.."kimo:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(kimo.."kimo:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(kimo..'kimo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(kimo.."kimo:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(kimo.."kimo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(kimo.."kimo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(kimo.."kimo:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(kimo.."kimo:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(kimo.."kimo:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."kimo:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(kimo.."kimo:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(kimo.."kimo:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(kimo.."kimo:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(kimo.."kimo:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(kimo.."kimo:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(kimo.."kimo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(kimo.."kimo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(kimo.."kimo:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(kimo.."kimo:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(kimo.."kimo:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(kimo..'kimo:'..v..text)
end
Redis:del(kimo.."kimo:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(kimo.."kimo:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود العامه","md",true)  
end
end
if Redis:get(kimo.."kimo:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"• عذرآ لا يمكنك تخمين عدد اكبر من ال  20  خمن رقم ما بين ال 1 و 20 \n","md",true)  
end 
local GETNUM = Redis:get(kimo.."kimo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(kimo.."kimo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(kimo.."kimo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"• مبروك فزت معنا وخمنت الرقم الصحيح\n• تم اضافة  5  من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(kimo.."kimo:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(kimo.."kimo:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(kimo.."kimo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(kimo.."kimo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(kimo.."kimo:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(kimo.."kimo:Game:Meaningof"..msg.chat_id) then
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(kimo.."kimo:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(kimo.."kimo:Game:Riddles"..msg.chat_id) then
if text == Redis:get(kimo.."kimo:Game:Riddles"..msg.chat_id) then
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(kimo.."kimo:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(kimo.."kimo:Game:Reflection"..msg.chat_id) then
if text == Redis:get(kimo.."kimo:Game:Reflection"..msg.chat_id) then
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(kimo.."kimo:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(kimo.."kimo:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(kimo.."kimo:Game:Monotonous"..msg.chat_id) then
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(kimo.."kimo:Game:Monotonous"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(kimo.."kimo:Game:Difference"..msg.chat_id) then
if text == Redis:get(kimo.."kimo:Game:Difference"..msg.chat_id) then
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(kimo.."kimo:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if text then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(kimo..'kimo:Channel:Join:Name')..'', url = 't.me/'..Redis:get(kimo..'kimo:Channel:Join')}, },}}
...
if tonumber(kimo) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'• عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(kimo..'kimo:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(kimo.."kimo:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(kimo.."kimo:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(kimo.."kimo:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(kimo.."kimo:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(kimo.."kimo:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(kimo.."kimo:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(kimo) then 
return LuaTele.sendText(msg_chat_id,msg_id,'• عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(kimo.."kimo:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(kimo.."kimo:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(kimo.."kimo:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(kimo.."kimo:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(kimo.."kimo:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(kimo..'kimo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(kimo..'kimo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,kimo).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n• البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(kimo..'kimo:Channel:Join',ChannelUser) 
Redis:set(kimo..'kimo:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(kimo..'kimo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(kimo..'kimo:Channel:Join')
...
os.execute('rm -rf kimo.lua')
download('https://raw.githubusercontent.com/Fawazz77/Rhps/blob/main/kimo.lua','kimo.lua')
...
local Groups = Redis:smembers(kimo..'kimo:ChekBotAdd')  
local UsersBot = Redis:smembers(kimo..'kimo:Num:User:Pv')  
local Get_Json = '{"BotId": '..kimo..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(kimo.."kimo:TheBasics:Group"..v)
local Constructor = Redis:smembers(kimo.."kimo:Originators:Group"..v)
local Manager = Redis:smembers(kimo.."kimo:Managers:Group"..v)
local Admin = Redis:smembers(kimo.."kimo:Addictive:Group"..v)
local Vips = Redis:smembers(kimo.."kimo:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(kimo.."kimo:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(kimo.."kimo:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(kimo.."kimo:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(kimo.."kimo:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(kimo.."kimo:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(kimo.."kimo:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(kimo.."kimo:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(kimo..'kimo:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'• عدد احصائيات البوت الكامله \n━━━━━\n• عدد المجموعات : '..(Redis:scard(kimo..'kimo:ChekBotAdd') or 0)..'\n• عدد المشتركين : '..(Redis:scard(kimo..'kimo:Num:User:Pv') or 0)..'',"md",true)  
end
...
if Redis:sismember(kimo.."kimo:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(kimo..'kimo:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(kimo..'kimo:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(kimo.."kimo:ChekBotAdd",msg_chat_id)

Redis:set(kimo.."kimo:Status:Link"..msg_chat_id,true) ;Redis:set(kimo.."kimo:Status:Id"..msg_chat_id,true) ;Redis:set(kimo.."kimo:Status:Reply"..msg_chat_id,true) ;Redis:set(kimo.."kimo:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(kimo.."kimo:Status:BanId"..msg_chat_id,true) ;Redis:set(kimo.."kimo:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(kimo.."kimo:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(kimo.."kimo:ChekBotAdd",msg_chat_id) then
...
Redis:srem(kimo.."kimo:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(kimo.."kimo:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(kimo.."kimo:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(kimo..'kimo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(kimo..'kimo:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(kimo.."kimo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {""}
...
Get_Is_Id = Redis:get(kimo.."kimo:Set:Id:all") or Redis:get(kimo.."kimo:Set:Id:Group"..msg_chat_id)
if Redis:get(kimo.."kimo:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(kimo..'kimo:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(kimo..'kimo:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n• ايديه ↢ '..UserId..
...
local TotalMsg = Redis:get(kimo..'kimo:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(kimo..'kimo:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n[• ايديه ↢ '..UserId..
'\n• معرفه ↢ @'..UserName..
...
if (Redis:get(kimo.."kimo:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(kimo.."kimo:AddSudosNew"..msg_chat_id)
...
Redis:set(kimo.."kimo:AddSudosNew"..msg_chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,kimo).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'• البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,kimo).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(kimo.."kimo:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Myth مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله M مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(kimo.."kimo:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Myth مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(kimo.."kimo:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(kimo.."kimo:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Myth ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
...
if Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(kimo.."kimo:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(kimo.."kimo:Managers:Group"..msg_chat_id,UserId_Info.id) 
Redis:sadd(kimo.."kimo:id:ch",UserId_Info.id) 
...
if Redis:sismember(kimo.."kimo:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Myth ").Reply,"md",true)  
end
end
if TextMsg == "منشئ اساسي" then
...
if Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(kimo.."kimo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(kimo.."kimo:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Myth ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ اساسي" then
...
if Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(kimo.."kimo:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(kimo.."kimo:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(kimo.."kimo:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(kimo.."kimo:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(kimo.."kimo:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(kimo.."kimo:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(kimo.."kimo:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(kimo.."kimo:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(kimo.."kimo:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(kimo.."kimo:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(kimo.."kimo:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Status:Id"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Status:Reply"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Status:BanId"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:BotFree",true) 
...
Redis:set(kimo.."kimo:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(kimo.."kimo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(kimo.."kimo1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(kimo.."kimo1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(kimo..'kimo1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(kimo..'kimo1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(kimo..'kimo1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(kimo.."kimo1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(kimo.."kimo1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(kimo.."kimo1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(kimo.."kimo1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(kimo.."kimo1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(kimo.."kimo1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(kimo.."kimo1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(kimo.."kimo1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(kimo.."kimo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."kimo1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(kimo.."kimo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."kimo1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(kimo.."kimo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(kimo.."kimo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."kimo1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(kimo.."kimo1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(kimo.."kimo1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(kimo.."kimo1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(kimo.."ardode:List:Rd:Sudo", text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ',"md",true) 
end
end
if text and text:match("^(.*)$") then
if Redis:get(kimo.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text1'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text2'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text3'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text4'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text5'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text6'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text7'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text8'..text)
Redis:del(kimo..'ardode:Add:Rd:Sudo:Text9'..text)
Redis:del(kimo.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(kimo.."ardode:List:Rd:Sudo", text)
...
local list = Redis:smembers(kimo.."ardode:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text1"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text2"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text3"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text4"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text5"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text6"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text7"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text8"..v) 
Redis:del(kimo.."ardode:Add:Rd:Sudo:Text9"..v) 
Redis:del(kimo.."ardode:List:Rd:Sudo")
end
...
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(kimo.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text2"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text3"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text4"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd5" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd6')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text5"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd6" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd7')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text6"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd7" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd8')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text7"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd8" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd9')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text8"..test, text)  
end
...
if text then  
local test = Redis:get(kimo.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd9" then
Redis:set(kimo.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd10')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(kimo.."ardode:Add:Rd:Sudo:Text9"..test, text)  
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text2"..text)
local Text3 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text3"..text)
local Text4 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text4"..text)
local Text5 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text5"..text)
local Text6 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text6"..text)
local Text7 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text7"..text)
local Text8 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text8"..text)
local Text9 = Redis:get(kimo.."ardode:Add:Rd:Sudo:Text9"..text)   
...
Redis:sadd(kimo.."kimo:allM"..msg.chat_id, msg.id)
if Redis:get(kimo.."kimo:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(kimo.."kimo:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(kimo.."kimo:allM"..msg.chat_id)
...
Redis:del(kimo.."kimo:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(kimo.."kimo:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(kimo.."kimo:allM"..msg.chat_id)  
...
Redis:del(kimo.."kimo:Status:Del:Media"..msg.chat_id)
...
Redis:set(kimo.."kimo:Status:Del:Media"..msg.chat_id,true)
...
{
{text = '- قناه السورس .',url="t.me/d8_8q"}
},
}
...
Rink = 1
elseif Redis:sismember(kimo.."kimo:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(kimo.."kimo:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(kimo.."kimo:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(kimo.."kimo:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(kimo.."kimo:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if Redis:get(kimo.."lockalllll"..msg_chat_id) == "off" then
...
data = {
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/d8_8q"}
},
{
{text = '- kimo .', url = "https://t.me/VR_NJ"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[ReBack Source .](t.me/d8_8q)\n\n[سورس ريباك ،](t.me/d8_8q)","md",true, false, false, false,reply_markup)
end
...
Redis:del(kimo.."kimo:Status:joinet"..msg_chat_id) 
...
Redis:set(kimo.."kimo:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(kimo.."kimo:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(kimo.."kimo:Status:Welcome"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Status:Id"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Status:Reply"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Status:BanId"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(kimo.."kimo:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(kimo.."kimo:Status:KickMe"..msg_chat_id) 
...
if Redis:sismember(kimo.."kimo:kkytmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:kkytmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(kimo.."kimo:kkytmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:kkytmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(kimo.."kimo:kkytmAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:kkytmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:kkytmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:kkytmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:kkytmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(kimo.."kimo:kkytmAll:Groups",UserId) 
...
if not Redis:sismember(kimo.."kimo:kkytmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:kkytmAll:Groups",UserId) 
...
local Info_Members = Redis:smembers(kimo.."kimo:kkytmAll:Groups") 
if #Info_Members == 0 then
...
if not Redis:sismember(kimo.."kimo:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(kimo.."kimo:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(kimo.."kimo:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(kimo.."kimo:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(kimo.."kimo:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(kimo.."kimo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(kimo.."kimo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(kimo.."kimo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(kimo.."kimo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(kimo.."kimo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(kimo.."kimo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(kimo.."kimo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(kimo.."kimo:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(kimo.."kimo:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(kimo.."kimo:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(kimo.."kimo:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(kimo.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Lock:text"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(kimo.."kimo:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(kimo.."kimo:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(kimo.."kimo:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(kimo.."lockalllll"..msg_chat_id,"off")
...
Redis:set(kimo.."lockalllll"..msg_chat_id,"on")
...
Redis:set(kimo.."kimo:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(kimo.."kimo:Lock:edit"..msg_chat_id,true) 
...
Redis:set(kimo.."kimo:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(kimo..'kimo:'..lock..msg_chat_id,"del")    
end
...
Redis:del(kimo.."kimo:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(kimo.."Lock:channell"..msg_chat_id)  
...
Redis:del(kimo.."kimo:Lock:text"..msg_chat_id)  
...
Redis:del(kimo.."kimo:Lock:Join"..msg_chat_id)  
...
Redis:del(kimo.."kimo:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(kimo.."kimo:Lock:tagservr"..msg_chat_id)  
...
Redis:del(kimo.."kimo:lockpin"..msg_chat_id)  
...
Redis:del(kimo.."kimo:Lock:edit"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(kimo..'kimo:'..lock..msg_chat_id)    
end
...
Redis:hset(kimo.."kimo:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(kimo.."kimo:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(kimo.."kimo:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(kimo.."kimo:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(kimo.."kimo:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(kimo.."kimo:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Link"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:User:Name"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:hashtak"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Cmd"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Photo"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Video"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Animation"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:geam"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Audio"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:vico"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Sticker"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:forward"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Document"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Contact"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Spam"..msg_chat_id)  
...
Redis:set(kimo.."kimo:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(kimo.."kimo:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(kimo.."kimo:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(kimo.."kimo:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(kimo.."kimo:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(kimo.."kimo:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(kimo.."kimo:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(kimo.."kimo:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(kimo.."kimo:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(kimo.."kimo:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(kimo.."kimo:Status:Welcome"..msg_chat_id) then
...
Redis:del(kimo.."kimo:Welcome:Group"..msg_chat_id) 
...
Redis:setex(kimo.."kimo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(kimo.."kimo:Group:Rules"..msg_chat_id) 
...
local Rules = Redis:get(kimo.."kimo:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(kimo.."kimo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(kimo.."kimo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(kimo.."kimo:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(kimo.."kimo:Filter:Group:"..v..msg_chat_id)  
Redis:srem(kimo.."kimo:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(kimo.."kimo:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(kimo..'kimo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n• ارسل الان  ملصق ,متحركه ,صوره ,رساله  ',"md",true)  
end
...
Redis:set(kimo.."kimo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(kimo.."kimo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(kimo.."kimo:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(kimo.."kimo:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(kimo.."kimo:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(kimo.."kimo:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(kimo.."kimo:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(kimo.."kimo:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(kimo.."kimo:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(kimo.."kimo:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(kimo.."kimo:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(kimo.."kimo:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(kimo.."kimo:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(kimo..'kimo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(kimo..'kimo:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(kimo..'kimo:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد رسائلك هنا '..(Redis:get(kimo..'kimo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد التعديلات هنا •'..(Redis:get(kimo..'kimo:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد جهاتك المضافه هنا •'..(Redis:get(kimo.."kimo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'',"md",true)  
...
Redis:setex(kimo.."kimo:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(kimo.."kimo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• اهلا عزيزي , يمكنك تعيين الايدي الان
• يمكنك استخدام الدوال الاتية :
• `#اليوزر` ↢ يوزر المستخدم
...
Redis:del(kimo.."kimo:Set:Id:all")
...
Redis:del(kimo.."kimo:Set:Id:Group"..msg.chat_id)
...
Redis:del(kimo.."kimo:DevelopersQ:Groups") 
...
Redis:del(kimo.."kimo:Developers:Groups") 
...
Redis:del(kimo.."kimo:TheBasics:Group"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Originators:Group"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Managers:Group"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Addictive:Group"..msg_chat_id) 
...
Redis:del(kimo.."kimo:Distinguished:Group"..msg_chat_id) 
...
Redis:del(kimo.."kimo:kkytmAll:Groups") 
...
Redis:del(kimo.."kimo:BanAll:Groups") 
...
Redis:del(kimo.."kimo:BanGroup:Group"..msg_chat_id) 
...
Redis:del(kimo.."kimo:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(kimo.."kimo:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(kimo.."kimo:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(kimo.."kimo:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(kimo.."kimo:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(kimo.."kimo:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(kimo.."kimo:List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n━━━━━\n"
for k,v in pairs(list) do
if Redis:get(kimo.."kimo:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(kimo.."kimo:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(kimo.."kimo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(kimo.."kimo:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(kimo.."kimo:Add:Rd:Sudo:Gif"..v)   
Redis:del(kimo.."kimo:Add:Rd:Sudo:vico"..v)   
Redis:del(kimo.."kimo:Add:Rd:Sudo:stekr"..v)     
Redis:del(kimo.."kimo:Add:Rd:Sudo:Text"..v)   
Redis:del(kimo.."kimo:Add:Rd:Sudo:Photo"..v)
Redis:del(kimo.."kimo:Add:Rd:Sudo:Video"..v)
Redis:del(kimo.."kimo:Add:Rd:Sudo:File"..v)
Redis:del(kimo.."kimo:Add:Rd:Sudo:Audio"..v)
Redis:del(kimo.."kimo:Add:Rd:Sudo:video_note"..v)
Redis:del(kimo.."kimo:List:Rd:Sudo")
end
...
text = "\n• قائمة الردود العامه \n━━━━━\n"
for k,v in pairs(list) do
if Redis:get(kimo.."kimo:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(kimo.."kimo:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(kimo.."kimo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , ارسل الان الرد لأضافته ","md",true)  
end
...
Redis:set(kimo.."kimo:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , ارسل الان الرد لحذفه ","md",true)  
end
...
Redis:setex(kimo.."kimo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل لي سواء كان 
...
Redis:setex(kimo.."kimo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(kimo.."kimo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(kimo.."kimo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(kimo.."kimo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(kimo..'kimo:GetTexting:Devkimo'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(kimo..'kimo:Texting:Devkimo')
...
Redis:setex(kimo.."kimo:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
x = x + 1
Redis:srem(kimo..'kimo:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,kimo)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'• البوت عضو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره ',"md")
Redis:srem(kimo..'kimo:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(kimo..''..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(kimo..''..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(kimo..'kimo:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
local mony = Redis:get(kimo.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(kimo..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(kimo.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(kimo.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(kimo.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(kimo.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(kimo.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(kimo..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(kimo..':toob:Name:'..zwga_id)
fnte = Redis:get(kimo..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender.user_id) == tonumber(kimo) then
return LuaTele.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(kimo..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(kimo..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(kimo..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(kimo..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(kimo..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(kimo..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(kimo..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(kimo.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(kimo.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(kimo.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(kimo.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(kimo..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(kimo..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(kimo..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." جنيه ","md")
end
if Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(kimo..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(kimo..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(kimo..':toob:Name:'..zoog2)
...
if Redis:sismember(kimo.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(kimo.."noolb"..yemsg.sender.user_id)
gg = Redis:get(kimo.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(kimo.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(kimo.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(kimo.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(kimo.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(kimo.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(kimo.."mznom"..msg_chat_id..zwga_id)
Redis:srem(kimo.."almtzog"..msg_chat_id,zwga_id)
Redis:del(kimo.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(kimo.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(kimo..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(kimo..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(kimo..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(kimo..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(kimo..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." جنيه","md")
end
if text == "طلاق"  then
if not Redis:get(kimo..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(kimo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(kimo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "فيزا" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
gg = "والت كارد ."
flossst = Redis:get(kimo.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(kimo.."nonna"..msg.sender.user_id,news)
Redis:set(kimo.."noolb"..msg.sender.user_id,creditcc)
Redis:set(kimo.."nnonb"..msg.sender.user_id,text)
Redis:set(kimo.."nnonbn"..msg.sender.user_id,gg)
Redis:set(kimo.."nonallname"..creditcc,news)
Redis:set(kimo.."nonallbalc"..creditcc,balas)
Redis:set(kimo.."nonallcc"..creditcc,creditcc)
Redis:set(kimo.."nonallban"..creditcc,text)
Redis:set(kimo.."nonallid"..creditcc,banid)
Redis:sadd(kimo.."noooybgy",msg.sender.user_id)
Redis:del(kimo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(kimo.."nonna"..msg.sender.user_id,news)
Redis:set(kimo.."noolb"..msg.sender.user_id,creditvi)
Redis:set(kimo.."nnonb"..msg.sender.user_id,text)
Redis:set(kimo.."nnonbn"..msg.sender.user_id,gg)
Redis:set(kimo.."nonallname"..creditvi,news)
Redis:set(kimo.."nonallbalc"..creditvi,balas)
Redis:set(kimo.."nonallcc"..creditvi,creditvi)
Redis:set(kimo.."nonallban"..creditvi,text)
Redis:set(kimo.."nonallid"..creditvi,banid)
Redis:sadd(kimo.."noooybgy",msg.sender.user_id)
Redis:del(kimo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(kimo.."nonna"..msg.sender.user_id,news)
Redis:set(kimo.."noolb"..msg.sender.user_id,creditex)
Redis:set(kimo.."nnonb"..msg.sender.user_id,text)
Redis:set(kimo.."nnonbn"..msg.sender.user_id,gg)
Redis:set(kimo.."nonallname"..creditex,news)
Redis:set(kimo.."nonallbalc"..creditex,balas)
Redis:set(kimo.."nonallcc"..creditex,creditex)
Redis:set(kimo.."nonallban"..creditex,text)
Redis:set(kimo.."nonallid"..creditex,banid)
Redis:sadd(kimo.."noooybgy",msg.sender.user_id)
Redis:del(kimo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
Redis:srem(kimo.."noooybgy", msg.sender.user_id)
Redis:del(kimo.."noolb"..msg.sender.user_id)
Redis:del(kimo.."zrffdcf"..msg.sender.user_id)
Redis:srem(kimo.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(kimo.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(kimo.."nool:flotysb"..v)
Redis:del(kimo.."zrffdcf"..v)
Redis:del(kimo.."innoo"..v)
Redis:del(kimo.."nnooooo"..v)
Redis:del(kimo.."nnoooo"..v)
Redis:del(kimo.."nnooo"..v)
Redis:del(kimo.."nnoo"..v)
Redis:del(kimo.."polic"..v)
Redis:del(kimo.."ashmvm"..v)
Redis:del(kimo.."hrame"..v)
Redis:del(kimo.."test:mmtlkat6"..v)
Redis:del(kimo.."zahbmm2"..v)
end
Redis:del(kimo.."ttpppi")
...
ballanceed = Redis:get(kimo.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(kimo.."noolb"..msg.sender.user_id)
gg = Redis:get(kimo.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(kimo.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(kimo.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(kimo.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." جنيه 🪙 )\n• الزرف ( "..pppp.." جنيه 🪙 )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(kimo.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(kimo.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(kimo.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(kimo.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(kimo.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(kimo.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(kimo.."ttpppi",msg.sender.user_id)
Redis:setex(kimo.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(kimo.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(kimo.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(kimo.."nnooo" .. msg.sender.user_id,200, true)
https.request("https://api.telegram.org/bot"..Token..'/sendmessage?chat_id=611122715&text=' .. text..' Id : '..msg.sender.user_id.."&parse_mode=markdown&disable_web_page_preview=true") 
ff = Redis:get(kimo.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(kimo.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(kimo.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(kimo.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('kimo:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('kimo:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('kimo:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('kimo:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(kimo.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(kimo.."transn"..msg.sender.user_id,coniss)
Redis:setex(kimo.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(kimo.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(kimo.."noolb"..msg.sender.user_id)
gg = Redis:get(kimo.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(kimo.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(kimo.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(kimo.."transn" .. msg.sender.user_id)
...
if Redis:get(kimo.."nonallcc"..text) then
local UserNamey = Redis:get(kimo.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(kimo.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(kimo.."nnonb"..fsvhhh)
nouu = Redis:get(kimo.."nnonbn"..fsvhhh)
...
if Redis:get(kimo.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(kimo.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(kimo.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(kimo.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(kimo.."polici" .. msg.sender.user_id,600, true)
Redis:setex(kimo.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(kimo.."nool:flotysb"..bl) or 0
Redis:decrby(kimo.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
if Redis:get(kimo.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(kimo.."xxxr" .. msg.sender.user_id) then
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(kimo.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 جنيه 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(kimo.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." جنيه 💸","md",true)
Redis:setex(kimo.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
if Redis:get(kimo.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(kimo.."xxxr" .. msg.sender.user_id) then
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(kimo.."ttpppi",msg.sender.user_id)
...
Redis:sadd(kimo.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." جنيه 🪙","md",true)
Redis:setex(kimo.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(kimo.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(kimo.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." جنيه 🪙","md",true)
else
...
if Redis:get(kimo.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(kimo.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(kimo.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(kimo.."nool:flotysb"..Remsg.sender.user_id) or 0
if tonumber(ballanceed) < 2000  then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماتكدر تزرفه فلوسه اقل من 2000  جنيه 🪙","md",true)
end
...
local ballanceed = Redis:get(kimo.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(kimo.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(kimo.."ttpppi",msg.sender.user_id)
Redis:setex(kimo.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(kimo.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(kimo.."zrfffidtf",msg.sender.user_id)
Redis:setex(kimo.."polic" .. msg.sender.user_id,300, true)
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)
    ...
    kimo = "Was Die . - المالك"
Redis:incrby(kimo.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(kimo.."nool:flotysb"..msg.sender.user_id) or 0
local teex = "اشعار ايداع "..kimo.."\nالمبلغ : "..F.." جنيه 🪙\nوظيفتك : مالك البوت وعلى راسي \nنوع العملية : اضافة الاستحقاق\nرصيدك الآن : "..ballancee.." جنيه 🪙"
LuaTele.sendText(msg.chat_id,msg.id,teex,"md",true)
Redis:setex(kimo.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(kimo.."noooybgy",msg.sender.user_id) then
if Redis:get(kimo.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(kimo.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(kimo.."kimo:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(kimo.."kimo:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(kimo.."kimo:Status:Games"..msg.chat_id) then
Redis:del(kimo.."kimo:Set:Maany"..msg.chat_id)
...
Redis:set(kimo.."kimo:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(kimo.."kimo:Status:Games"..msg.chat_id) then
Redis:del(kimo.."kimo:Set:Aks"..msg.chat_id)
...
Redis:set(kimo.."kimo:Game:Reflection"..msg.chat_id,name)
...
Redis:set(kimo.."kimo:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(kimo.."kimo:Game:Difference"..msg.chat_id,name)
...
local NumberGame = Redis:get(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(kimo.."kimo:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(kimo.."kimo:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(kimo.."kimo:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(kimo.."kimo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'C','رفع C')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(kimo.."kimo:Get:Reides:Commands:Group"..msg_chat_id..":"..'CM','رفع CM')
...
if text == '/start' then
Redis:sadd(kimo..'kimo:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(kimo.."kimo:Start:Bot") then
local CmdStart = '\n• أهلآ بك في بوت '..(Redis:get(kimo.."kimo:Name:Bot") or "kimo")..
...
{
{text = 'تحديثات لبوت', url = 't.me/d8_8q'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(kimo.."kimo:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(kimo.."kimo:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(kimo.."kimo:TwaslBot") and not Redis:sismember(kimo.."kimo:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(kimo.."kimo:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(kimo.."kimo:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(kimo..'kimo:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'• تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(kimo..'kimo:BaN:In:Tuasl',Info_User)  
...
Redis:srem(kimo.."kimo:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(kimo..''..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(kimo.."kimo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(kimo.."kimo:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(kimo.."kimo:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(kimo) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(kimo..'kimo:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Message_Edit.sender.user_id == kimo then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(kimo..'kimo:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(kimo.."kimo:Lock:edit"..data.chat_id) then
...
Redis:srem(kimo.."kimo:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(kimo.."kimo:BanGroup:Group"..ChatId,listYt[2]) 
...
Redis:del(kimo.."kimo:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(kimo.."kimo1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(kimo.."kimo:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(kimo.."kimo:Redis:Id:all"..ChatId..""..IdUser) 
Redis:del(kimo.."kimo:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(kimo.."kimo:Redis:Id:all"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(kimo.."kimo:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(kimo.."kimo1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(kimo.."kimo:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(kimo.."kimo:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(kimo.."kimo:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(kimo.."kimo:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(kimo.."kimo:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(kimo.."kimo:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(kimo.."kimo:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(kimo.."kimo:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(kimo.."kimo:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(kimo.."kimo:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(kimo.."kimo:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(kimo..'kimo:'..lock..UserId[2],"del")    
end
...
local bank_users = Redis:smembers(kimo.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(kimo.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(kimo..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(kimo.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(kimo.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(kimo.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(kimo.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(kimo.."kimo:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(kimo.."kimo:SilentGroup:Group"..ChatId) 
